...
;
	($.$mol_icon_map_marker_check) = class $mol_icon_map_marker_check extends ($.$mol_icon) {
		path(){
...
;
	($.$hyoo_js_opt) = class $hyoo_js_opt extends ($.$mol_book2) {
		Theme(){
		...
		Source(){
			...
			(obj.uri) = () => ("https://github.com/hyoo-ru/opt.js.hyoo.ru");
			return obj;
		}
		Lights(){
		...
		File(id){
			const obj = new this.$.$mol_link();
			(obj.title) = () => ((this.file_uri(id)));
			(obj.arg) = () => ({"file": (this.file_uri(id)), "inline": null});
			return obj;
		}
		menu_content(){
		...
		pages(){
			return [(this.Menu_page()), (this.Script("0"))];
		}
	};
	($mol_mem(($.$hyoo_js_opt.prototype), "Theme"));
	($mol_mem(($.$hyoo_js_opt.prototype), "Source"));
	($mol_mem(($.$hyoo_js_opt.prototype), "Lights"));
	($mol_mem_key(($.$hyoo_js_opt.prototype), "File"));
	($mol_mem(($.$hyoo_js_opt.prototype), "Menu"));
	($mol_mem(($.$hyoo_js_opt.prototype), "Hint"));
	($mol_mem(($.$hyoo_js_opt.prototype), "Menu_content"));
	($mol_mem(($.$hyoo_js_opt.prototype), "Menu_page"));
	($mol_mem_key(($.$hyoo_js_opt.prototype), "Script"));
	($.$hyoo_js_opt_script) = class $hyoo_js_opt_script extends ($.$mol_page) {
		search(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		Native_marker(id){
			...
			(obj.bubble_content) = () => ([(this.Point_hint(id))]);
			return obj;
		}
		Native(id){
			const obj = new this.$.$mol_follower();
		...
		tools(){
			return [(this.Search()), (this.Close())];
		}
		foot(){
			return [(this.Filters()), (this.Jump())];
		}
		body(){
			return [
				(this.Code()), 
	...
	($mol_mem(($.$hyoo_js_opt_script.prototype), "search"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "Search"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "Close_icon"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "Close"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "filter_enabled"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "Filters"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "jump"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "Jump"));
	($mol_mem(($.$hyoo_js_opt_script.prototype), "Code"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Point_anchor"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Func_marker"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Func"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Native_icon"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Native_anchor"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Point_hint"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Native_marker"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Native"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Inline_icon"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Inline_button"));
	($mol_mem_key(($.$hyoo_js_opt_script.prototype), "Inline"));
	($.$hyoo_js_opt_script_func_marker) = class $hyoo_js_opt_script_func_marker extends ($.$mol_link) {
		optimized(){
			return true;
		}
		attempts(){
		...
		attr(){
			return {...(super.attr()), "hyoo_js_opt_script_func_marker_optimized": (this.optimized())};
		}
		sub(){
    ...
    (function ($$) {
        class $hyoo_js_opt extends $.$hyoo_js_opt {
            ...
            script_source(deep) {
                const point = this.point(deep);
                if ('asm' in point)
                    return { uri: 'ASM', start: 0, end: point.asm.length };
                return point.source;
            }
            points(deep) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_js_opt.prototype, "data", null);
        __decorate([
            $mol_mem
        ], $hyoo_js_opt.prototype, "files", null);
        __decorate([
            $mol_mem
        ], $hyoo_js_opt.prototype, "menu_content", null);
        __decorate([
            $mol_mem
        ], $hyoo_js_opt.prototype, "inline_path", null);
        __decorate([
            $mol_mem_key
        ...
        class $hyoo_js_opt_script extends $.$hyoo_js_opt_script {
            ...
            jump_rows() {
                ...
                for (let i = 0; i < followers.length; ++i) {
                    ...
                    const line = $mol_owning_get(anchor).host;
                    lines.add(line);
                }
                return [...lines];
            }
            jump(next) {
                ...
                if (next < 1)
                    next = lines.length;
                if (next)
                    this.Code().ensure_visible(lines[next - 1]);
                return next;
            }
            filter_enabled(id, next) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_js_opt_script.prototype, "Foot", null);
        __decorate([
            $mol_mem_key
        ...
        __decorate([
            $mol_mem
        ], $hyoo_js_opt_script.prototype, "jump", null);
